<div id="confirmDelModal" class="invisible opacity-0 pointer-events-none modal-custom fixed z-10 inset-0 overflow-y-hidden" aria-labelledby="modal-title" role="dialog" aria-modal="true">
    <div class="flex items-end justify-center min-h-screen pb-20 text-center sm:block p-0">
        ...
        <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            ...
            <div class="sm:mt-0 sm:ml-4 sm:text-left">
                ...
                <p class="text-sm text-gray-500">
                    Are you sure you want to delete the shop? This action cannot be undone.
                </p>
                </div>
            </div>
            </div>
        ...
        <div class=" bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
            ...
            <button type="button" class="cancelDelBtn mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                Cancel
            </button>
        </div>
        </div>
